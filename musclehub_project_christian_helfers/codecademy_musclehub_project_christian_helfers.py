...
labels = ["A - has fitness_test_date", "B - has no fitness_test_date"]
...
print(pval)
#reject H0; data shows significant differences between A and B
...
chi2, pval, dof, expected = chi2_contingency(X)
print(pval)
#cannot reject H0; data shows no significant differences between A and B
...
# Percent of Visitors who Apply
ax = plt.subplot()
plt.title("Percent of Visitors who Apply by Fitness Test")
...
ax = plt.subplot()
plt.title("Percent of Applicants who purchase Membership by Fitness Test")
...
ax = plt.subplot()
plt.title("Percent of Visitors who purchase Membership by Fitness Test")
